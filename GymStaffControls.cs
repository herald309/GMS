...
namespace GymManagement
{
    public partial class GymStaffControls : UserControl
    {
        ...
        private void SearchByIdentity_Click(object sender, EventArgs e)
        {
            ...
            {
                //DataView di = dtstaff.DefaultView;
                //di.RowFilter = "IDProof LIKE '%" + textBox1.Text + "%'";
                SqlConnection con = new SqlConnection(constr);
        ...
        //to select data from gridview and show in boxes
        private void StaffDataGridView_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
